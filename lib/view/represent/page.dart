...
class _RepresentSate extends State<Represent> with TickerProviderStateMixin {
  ...
  Future<Uint8List> tableCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = tablesGlobalKey.currentContext
  ...
  Future<Uint8List> axesCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = axesGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Future<Uint8List> barsCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = barsGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Future<Uint8List> comboCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = comboGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Future<Uint8List> legendsCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = legendsGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Future<Uint8List> piesCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = piesGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Future<Uint8List> linesCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = linesGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Future<Uint8List> timesCapturePng() async {
    // try {
    //   print('inside');
    final RenderRepaintBoundary boundary = timesGlobalKey.currentContext
        .findRenderObject() as RenderRepaintBoundary;
    final ui.Image image = await boundary.toImage(pixelRatio: 3.0);
    final ByteData byteData =
        await image.toByteData(format: ui.ImageByteFormat.png);
  ...
  Widget build(BuildContext context) {
                      ...
                      child: StoreProvider.of<AppState>(context)
                          ...
                          ? StoreConnector<AppState, List<bool>>(
                              converter: (Store<AppState> store) =>
                                  store.state.checkVal,
                              builder:
                                  (BuildContext context, List<bool> chckVal) {
                                return Checkbox(
                          ...
                          : StoreProvider.of<AppState>(context)
                              ...
                              ? StoreConnector<AppState, dynamic>(
                                  converter: (Store<AppState> store) =>
                                      store.state.radioValue,
                                  builder:
                                      (BuildContext context, dynamic radVal) {
                                    return Radio(
                                        ...
                                        onChanged: (dynamic i) {
                                          StoreProvider.of<AppState>(context)
                                              .dispatch(
                                                  HandleRadioValueChange(i));
                                          StoreProvider.of<AppState>(context)
                                              .dispatch(TableStructRad());
                                        });
                                  },
                                )
                              : null);
    ...
    Widget cards(
        String image, String title, String route, String check, int index) {
    ...
    Widget chartChuzzer(
        String title, double tl, double tr, double bl, double br) {
            ...
            return InkWell(
              onTap: () {
                ...
                StoreProvider.of<AppState>(context).dispatch(GlobalCreateData(
                    eyedee:
                        StoreProvider.of<AppState>(context).state.radioRes));
                StoreProvider.of<AppState>(context).dispatch(Canvas());
              },
              child: Container(
                height: SizeConfig.blockSizeVertical * 7,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                StoreConnector<AppState, bool>(
                  converter: (Store<AppState> store) =>
                      store.state.chartzVisible,
                  builder: (BuildContext context, bool data) {
                    return Visibility(
                      visible: StoreProvider.of<AppState>(context)
                          .state
                          .chartzVisible,
                      child: Container(
                        height: 350.0,
                        ...
                        child: GridView.count(
                            ...
                            children: [
                              ...
                              return StoreConnector<AppState, List<bool>>(
                                converter: (Store<AppState> store) =>
                                    store.state.axesSelected,
                                builder:
                                    (BuildContext context, List<bool> data) {
                                  ...
                                  builder: (BuildContext context, String data) {
                                    return DropdownButtonFormField(
                                      ...
                                      onChanged: (value) =>
                                          StoreProvider.of<AppState>(context)
                                              .dispatch(
                                                  AxisXVAL(value.toString())),
                                      hint: Text('X Axis'),
                                      items: StoreProvider.of<AppState>(context)
                                          .state
                                          .rett
                                          .where((col) =>
                                              col['name'].toString() != 'Id')
                                          .toList()
                                          .asMap()
                                          .entries
                                          .map((widget) {
                                        return DropdownMenuItem(
                                            value: StoreProvider.of<AppState>(
                                                    context)
                                                .state
                                                .rett[widget.key]['name']
                                                .toString(),
                                            child: Text(
                                  ...
                                  builder: (BuildContext context, String data) {
                                    return DropdownButtonFormField(
                                      ...
                                      onChanged: (value) {
                                        StoreProvider.of<AppState>(context)
                                            .dispatch(
                                                AxisYVAL(value.toString()));
                                        StoreProvider.of<AppState>(context)
                                            .dispatch(CreateGlobalData());
                                        StoreProvider.of<AppState>(context)
                                            .dispatch(GlobalCreateData(
                                                eyedee:
                                                    StoreProvider.of<AppState>(
                                                            context)
                                                        .state
                        ...
                        child: GridView.count(
                            ...
                            children: [
                              ...
                              cards(
                                  ...
                                  'radio',
                                  3),
                              cards('assets/charts/line_charts/points_full.png',
                                  'Points', 'PointsLineChart', 'radio', 4),
                              cards(
                              ...
                              cards(
                                  ...
                                  'radio',
                                  8),
                              cards('assets/charts/line_charts/simple_full.png',
                                  'Simple', 'SimpleLineChart', 'radio', 9),
                              cards(
                        ...
                        child: GridView.count(
                            ...
                            children: [
                              cards(
                                  ...
                                  'radio',
                                  0),
                              cards('assets/charts/pie_charts/donut_full.png',
                                  'Doughnut', 'DonutPieChart', 'radio', 1),
                              cards('assets/charts/pie_charts/gauge_full.png',
                                  'Gauge', 'GaugeChart', 'radio', 2),
                              cards(
                              ...
                              cards('assets/charts/pie_charts/simple_full.png',
                                  'Simple Pie', 'SimplePieChart', 'radio', 5),
                            ].asMap().entries.map((widget) {
                              return StoreConnector<AppState, List<bool>>(
                                converter: (Store<AppState> store) =>
                                    store.state.piesSelected,
                                builder:
                                    (BuildContext context, List<bool> data) {
                                  return ToggleButtons(
                                    selectedColor: Colors.red,
